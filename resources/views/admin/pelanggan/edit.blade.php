        ...
        <form method="POST" action="{{ route('admin.pelanggan.update',$pelanggan->id) }}">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="$pelanggan->nama "
                ...
                <div>
                    ...
                    <select id="jenis_kelamin" name="jenis_kelamin" class="block mt-1 w-full rounded-lg border-gray-300"
                        ...
                        <option {{ $pelanggan->jenis_kelamin == 'Laki-Laki' ? 'selected' : '' }} value="Laki-Laki" {{ old('jenis_kelamin') == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki
                        </option>
                        <option {{ $pelanggan->jenis_kelamin == 'Perempuan' ? 'selected' : '' }} value="Perempuan" {{ old('jenis_kelamin') == 'Perempuan' ? 'selected' : '' }}>Perempuan
                        </option>
                    </select>
