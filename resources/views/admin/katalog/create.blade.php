            ...
            <form method="POST" action="{{ route('admin.katalog.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="mb-2">
                        ...
                        <x-text-input id="harga_beli" class="block mt-1 w-full" type="number" step="0.01" name="harga_beli" :value="old('harga_beli')" required autofocus autocomplete="harga_beli" />
