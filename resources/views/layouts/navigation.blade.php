        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <img src="{{ asset('gambar/logo.jpeg') }}" alt="Logo" class="block h-9 w-auto" />
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 gap-2">
                <a class="fa-solid fa-cart-shopping" href="{{ route('keranjang.index') }}">
                    </a>
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('user.pesanan')">
                                {{ __('Pesanan Saya') }}
                            </x-dropdown-link>
